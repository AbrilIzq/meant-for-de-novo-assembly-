...
goi.list <- "~/Desktop/" # change to input gene list 
working.directory = "~/Desktop/"  # change to working directory where you want output 

species = "mouse"   #currently one of "mouse", "human", "rat", "pig", "zebrafish"
outfile.prefix <- "specific" # prefix attached to output files. Ap
